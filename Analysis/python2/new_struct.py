...
('ColdGasRadius',np.float32,1),
('CosInclination',np.float32,1),
('DisruptOn',np.int32,1),
('MergeOn',np.int32,1),
('MagDust',np.float32,5),
('Mag',np.float32,5),
('MagBulge',np.float32,5),
...
('ColdGasMass_elementsRings',np.float32,[12,11]),

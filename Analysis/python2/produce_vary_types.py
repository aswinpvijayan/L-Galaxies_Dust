...
#for loop in range(0,1):
	...
	SM_bins[1][loop],Dust_bins[1][loop],Dust_std_dev[0][loop],Dust_std_err[0][loop],count[0][loop] = fit_scatter(log_Stellar_Mass_2, log_New_Dust_Mass_2, ret_n=True, ret_sterr=True, nbins=10)
	plt.subplot(3,2,1)
	plt.xlim([8,12])
	plt.ylim([0,10.2])
	...
	SM_bins[2][loop],Dust_bins[2][loop],Dust_std_dev[0][loop],Dust_std_err[0][loop],count[0][loop] = fit_scatter(log_Stellar_Mass_3, log_New_Dust_Mass_3, ret_n=True, ret_sterr=True, nbins=10)
	plt.subplot(3,2,2)
	plt.xlim([8,12])
	plt.ylim([0,10.2])
	...
	SM_bins[3][loop],Dust_bins[3][loop],Dust_std_dev[0][loop],Dust_std_err[0][loop],count[0][loop] = fit_scatter(log_Stellar_Mass_4, log_New_Dust_Mass_4, ret_n=True, ret_sterr=True, nbins=10)
	plt.subplot(3,2,3)
	plt.xlim([8,12])
	plt.ylim([0,10.2])
	...
	SM_bins[4][loop],Dust_bins[4][loop],Dust_std_dev[0][loop],Dust_std_err[0][loop],count[0][loop] = fit_scatter(log_Stellar_Mass_5, log_New_Dust_Mass_5, ret_n=True, ret_sterr=True, nbins=10)
	plt.subplot(3,2,4)
	plt.xlim([8,12])
	plt.ylim([0,10.2])
	...
	SM_bins[5][loop],Dust_bins[5][loop],Dust_std_dev[0][loop],Dust_std_err[0][loop],count[0][loop] = fit_scatter(log_Stellar_Mass_6, log_New_Dust_Mass_6, ret_n=True, ret_sterr=True, nbins=10)
	plt.subplot(3,2,5)
	plt.xlim([8,12])
	plt.ylim([0,10.2])

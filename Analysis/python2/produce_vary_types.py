...
#for loop in range(0,1):
    ...
    fig, axs = plt.subplots(nrows=3, ncols=2, sharex=True, sharey=True, figsize=(9,13.5))
    fig.subplots_adjust(hspace=0)
    fig.subplots_adjust(wspace=0)
    #plt.gca().set_aspect('equal', 'datalim')
    #fig.suptitle(r"z = %1.2f, topoloogy: 4 14 1. $\alpha$ = 0.15, $\eta$ = 0.25")
    ...
    axs.flatten()[0].set_yticklabels([6,8,10])

...
; plot for each field in the input LGalaxy struct a histogram
 ...
 print, 'plotting  elements[0]'
   plotHist, LGs.elements(0),'elements[0]','struct'
 print, 'plotting  elements[1]'
   plotHist, LGs.elements(1),'elements[1]','struct'
 print, 'plotting  elements[2]'
   plotHist, LGs.elements(2),'elements[2]','struct'
 print, 'plotting  elements[3]'
   plotHist, LGs.elements(3),'elements[3]','struct'
 print, 'plotting  elements[4]'
   plotHist, LGs.elements(4),'elements[4]','struct'
 print, 'plotting  elements[5]'
   plotHist, LGs.elements(5),'elements[5]','struct'
 print, 'plotting  elements[6]'
   plotHist, LGs.elements(6),'elements[6]','struct'
 print, 'plotting  elements[7]'
   plotHist, LGs.elements(7),'elements[7]','struct'
 print, 'plotting  elements[8]'
   plotHist, LGs.elements(8),'elements[8]','struct'
 print, 'plotting  elements[9]'
   plotHist, LGs.elements(9),'elements[9]','struct'
 print, 'plotting  elements[10]'
   plotHist, LGs.elements(10),'elements[10]','struct'
 print, 'plotting  elements[11]'
   plotHist, LGs.elements(11),'elements[11]','struct'
 print, 'plotting  elements[12]'
   plotHist, LGs.elements(12),'elements[12]','struct'
 print, 'plotting  elements[13]'
   plotHist, LGs.elements(13),'elements[13]','struct'
 print, 'plotting  elements[14]'
   plotHist, LGs.elements(14),'elements[14]','struct'
 print, 'plotting  elements[15]'
   plotHist, LGs.elements(15),'elements[15]','struct'
 print, 'plotting  elements[16]'
   plotHist, LGs.elements(16),'elements[16]','struct'
 print, 'plotting  elements[17]'
   plotHist, LGs.elements(17),'elements[17]','struct'
 print, 'plotting  elements[18]'
   plotHist, LGs.elements(18),'elements[18]','struct'
 print, 'plotting  elements[19]'
   plotHist, LGs.elements(19),'elements[19]','struct'
 print, 'plotting  elements[0]'
   plotHist, LGs.elements(0),'elements[0]','struct'
 print, 'plotting  elements[1]'
   plotHist, LGs.elements(1),'elements[1]','struct'
 ...
 print, 'plotting  elements'
   plotHist, LGs.elements,'elements','struct'
 print, 'plotting  Attenuation_Dust'
   plotHist, LGs.Attenuation_Dust,'Attenuation_Dust','F'
end

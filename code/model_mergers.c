...
<<<<<<< HEAD
	  ...
	  elements_add(Gal[merger_centralgal].ColdGasClouds_elements, Gal[merger_centralgal].ColdGasClouds_elements,-fraction);
	 
	  Gal[merger_centralgal].DustColdGasDiff_elements =
	  elements_add(Gal[merger_centralgal].DustColdGasDiff_elements, Gal[merger_centralgal].DustColdGasDiff_elements,-fraction);
	  Gal[merger_centralgal].DustColdGasClouds_elements =
	  elements_add(Gal[merger_centralgal].DustColdGasClouds_elements, Gal[merger_centralgal].DustColdGasClouds_elements,-fraction);
	  
	  Gal[merger_centralgal].DustColdGasDiff_elements.H = 0.;
      Gal[merger_centralgal].DustColdGasDiff_elements.He = 0.;
      Gal[merger_centralgal].DustColdGasClouds_elements.H = 0.;
